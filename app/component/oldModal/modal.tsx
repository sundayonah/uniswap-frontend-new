            ...
            >
               ...
               <div className="px-6 py-2 w-[85%]">
                  <div className="grid grid-cols-3">
                     {filteredTokens.map(({ name, symbol, logoURI }) => (
                        <div
                           key={symbol}
                           className="flex items-center border border-gray-500 m-1 rounded-lg p-1 gap-2"
                           onClick={() => onTokenSelect({ name, symbol, logoURI })} // Add this line
                  ...
                  <div className="scroll-component w-full h-[calc(100vh-510px)] overflow-y-auto">
                     {filteredTokens.map(({ logoURI, name, symbol, address }) => (
                        <div
                           ...
                           onClick={() => onTokenSelect({ name, symbol, logoURI, address })} // Add this line
